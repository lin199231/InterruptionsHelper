...
/**
 * Created by dhdev_000 on 2015/7/29.
 */
public class ClockFragment extends InterruptionHelperFragment implements OnSharedPreferenceChangeListener {
...
//        mList.setAdapter(mAdapter);
    ...
    public void onResume() {
        ...
        if (activity.getSelectedTab() == InterruptionHelper.CLOCK_TAB_INDEX) {
            setFabAppearance();
...
//        }
    ...
    public void setFabAppearance() {
        final InterruptionHelper activity = (InterruptionHelper) getActivity();
        if (mFab == null || activity.getSelectedTab() != InterruptionHelper.CLOCK_TAB_INDEX) {
            return;
        }
    ...
    public void setLeftRightButtonAppearance() {
        ...
        if (mLeftButton == null || mRightButton == null ||
                activity.getSelectedTab() != InterruptionHelper.CLOCK_TAB_INDEX) {
            return;
        }
